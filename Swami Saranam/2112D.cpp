...
void solve() {
    // i think like for all the nodes it should either have only indegree or outdegree 
    // for one node alone indegree 1 outdegree 1 net is 0
    ll x;
    cin>>x;
    vector<int>adjList(x+1);
    vector<int>adjList2[x+1]
    for(int i=1;i<x;i++){
        int num1;
        int num2;
        cin>>num1>>num2;
